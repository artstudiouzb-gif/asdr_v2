    ...
    <div class="entry-grid">
        <div class="entry-main">
            ...
            <div class="form-card">
                ...
                <div class="form-field u-inline-79a1c5a5db">
                    <label class="u-inline-e925a44577" for="badge">Бейдж категории</label>
                ...
                <div class="docs-container u-inline-2e1ca338d7" data-docs-container="<?= htmlspecialchars($defaultCode, ENT_QUOTES) ?>">
                    <?php foreach ($docs as $idx => $doc): ?>
                        <div class="doc-item-row u-inline-d0009063f3">
                            ...
                            <button type="button" class="btn btn--small btn--danger u-inline-22ca54a87e" onclick="this.closest('.doc-item-row').remove();" title="Удалить">✕</button>
                        </div>
                    <?php endforeach; ?>
                </div>
            </div>
...
<div class="form-actions form-actions--sticky">
    <div class="form-actions-left">
        ...
        <?php if (!empty(\App\Core\SocialSettings::readyNetworks())): ?>
            <label class="u-inline-7519b07094" title="Отправить публикацию в привязанные каналы (Telegram и др.) только при явном подтверждении">
                <input class="u-inline-546ceb205f" type="checkbox" name="publish_to_social" value="1" form="news_edit_form">
