...
<table class="data-table">
    ...
    <tbody>
        ...
        <?php foreach ($items as $item): ?>
            <tr>
                <td style="width:32px;"><input type="checkbox" name="ids[]" value="<?= (int) $item['id'] ?>" data-bulk-checkbox aria-label="Выбрать новость"></td>
                ...
                <td style="white-space:nowrap;"><?= \App\Core\View::renderPartial('admin/layout/lang_badges', ['siteLangs' => $siteLangs, 'has' => $langMap[(int) $item['id']] ?? [], 'module' => 'news', 'origId' => (int) $item['id']]) ?></td>
                <td>
