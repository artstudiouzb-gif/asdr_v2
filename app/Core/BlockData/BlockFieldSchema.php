    ...
    public static function all(): array
    {
        return self::$cache ??= [
            ...
            'news_feature' => [
                ...
                ], 'cards', '«Карточки» повторяют вид страницы новостей. «Мозаика» плотнее: помещает больше материалов на ту же высоту.'),
                ...
                'limit' => Field::int(
                    ...
                    12,
                    5,
                    'Всего, вместе с крупной. Для макета «Карточки» ряд заполняется без остатка при 5 или 9 (1 крупная + 4 или 8), для «Мозаики» — при 6.'
                ),
                'all_text' => Field::text('Ссылка «Все …» — текст', 'Все новости', '', 'Все новости'),
