...
final class AssetCollector
{
     ...
     *
     * Для leader_card и media_gallery здесь подключаются небольшие точечные
     * overrides после основной части темы. Они нужны для геометрии/теней,
     * которые должны гарантированно перекрывать старые правила, не перенося
     * целиком большие блочные файлы в поздний каскад.
     */
    private const CSS_MAP = [
        'leader_card' => '/assets/css/blocks/leader-card-tabs-fix.css',
        'media_gallery' => '/assets/css/blocks/media-gallery-layout-fix.css',
    ];
