...
final class AssetCollector
{
     ...
     *
     * Для leader_card здесь подключается небольшой override слоёв/теней после
     * основной части темы. Он вынесен отдельно, чтобы не менять каскад
     * большого leader-card.css и гарантированно перекрывать старые правила.
     */
