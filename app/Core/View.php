...
final class View
{
    ...
    public static function render(string $template, array $data = []): void
    {
        ...
        // Теги <style> (StyleVars и др.) получают nonce текущего запроса здесь,
        // на готовой странице: фрагменты из кэша несут устаревший или никакой.
        if (self::isPublic($template)) {
            $html = SecurityHeaders::injectStyleNonce($html);
        }
