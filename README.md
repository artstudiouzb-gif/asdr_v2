...
**Контент**
- Конструктор страниц: 42 типа блока (hero, слайдеры, галереи, FAQ,
...
├── templates/
│   ├── blocks/            # шаблоны блоков конструктора (40 файлов на 42 типа:
...
Нативный тест-раннер без PHPUnit регистрирует **1681 тестовых сценариев**;
...
| [docs/BLOCKS.md](docs/BLOCKS.md) | справочник всех 42 типов блоков и общих настроек секции |
