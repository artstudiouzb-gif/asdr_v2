...
const DESIGN_SCALE_CEILINGS = [
    ...
    // 156 -> 131: схлопнуты неразличимые на глаз варианты тёмной тени
    // (смещение ±2px, размытие ±4px, прозрачность ±0.02), точные совпадения
    // со ступенями ушли в var(--shadow-2/3). 131 -> 101: тёмные тени карточек,
    // панелей и «подъёмов» сведены к ступеням --shadow-rest…--shadow-lift-xl.
    'box-shadow' => 101,
    // 36 -> 32, тем же замером. 32 -> 21: производные --radius-xs/--radius-lg.
    'border-radius' => 21,
...
function quality_budgets(): array
{
    return [
        ...
        'public_hard_radius' => [
            ...
            // 90 -> 82: кнопки и поля форм, поиска и тулбаров перешли на --btn-radius/--radius-sm.
            // 82 -> 46: бейджи, метки, кольца фокуса и крупные панели сайта — на
            // --radius-xs/--radius-lg, тонкие полоски — на --radius-pill. Остаток —
            // портал /repo, страницы ошибок, панель доступности и админ-бар со
            // своим видом.
            'ceiling' => static fn (): int => 46,
            'measure' => static function (): array {
