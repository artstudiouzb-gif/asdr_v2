...
test('Все POST-маршруты проверяют CSRF', function (): void {
    ...
    $exempt = [
        ...
        // Отчёт о нарушении CSP шлёт сам браузер, без сессии и токена. Защита —
        // ограничитель частоты, предел тела и короткие строковые поля в журнале.
        '/_csp-report' => 'отчёты CSP: шлёт браузер без сессии, защищён FileRateLimiter',
    ];
